...
<div v-if="gameData">
    ...
    <section class="text-gray-700 body-font mt-10 mb-10">
        ...
        <div class="container mx-auto border border-dotted rounded mt-8 mb-8">
            <div class="min-w-xl mx-auto md:max-w-lg p-10">
                <ul class="flex flex-col gap-5 text-xl text-gray-300">
                    <li v-for="osts of gameData.soundtracks" class="border-b border-black rounded-sm cursor-pointer hover:text-white hover:bg-orange-600">
        ...
        <modal v-if="showModal" @close="handleClose">
            <iframe width="880" height="650" :src="modalUrl" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </modal>
    </section>
    ...
    <section class="text-gray-700 body-font mt-10 mb-10">
        ...
        <accordion title="Dates"></accordion>
        <accordion title="Trailer">
            <iframe width="100%" height="650" :src="trailerURL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </accordion>
...
.bg-white {
    opacity: 0.8; /* Adjust this value between 0 (transparent) and 1 (opaque) */
}
</style>
